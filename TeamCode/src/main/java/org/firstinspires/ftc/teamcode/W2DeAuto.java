...
public class W2DeAuto extends LinearOpMode {
    ...
    // Used to prevent unnecessary scans
    ...
    public void runOpMode() {
        ...
        svClaim = hardwareMap.get(Servo.class, "ClaimFlipper");
        ...
        landWheels(0.5, 1, strafeSpeed);

        strafe(2.25, strafeSpeed, direction.RIGHT);
    ...
    private void landWheels(double rotations, double tuckSpeed, double strafeSpeed){
